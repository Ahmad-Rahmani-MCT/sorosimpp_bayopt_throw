...
class Data_Logger: 
    def __init__(self, required_frames) : 
        ...
        filename = "ROS_sim_logs.csv"
        self.csv_file = open(os.path.join(script_path, filename), mode="w") #write mode, created if it doesn't exist and overwritten if it exists, self.csv_file is now an object you can write to
